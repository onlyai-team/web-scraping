...
export type { PageMetadata, ScrapeConfig, ScrapeJob, ScrapeResult } from "./scraper/types.js";
...
export type { SearchEngine, SearchResult, SearchResponse, SearchConfig } from "./search/types.js";
